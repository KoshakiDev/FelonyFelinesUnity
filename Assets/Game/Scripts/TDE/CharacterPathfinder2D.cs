...
namespace MoreMountains.TopDownEngine
{
    ...
    public class CharacterPathfinder2D : CharacterAbility
    {
        ...
        protected virtual void MoveController()
        {
            ...
            {
                //Debug.Log("Stopped because " + Target + " " + NextWaypointIndex);
            ...
            else
            {
                ...
                //Debug.Log("Moving in " + _direction + " towards " + Waypoints[NextWaypointIndex] + " index " + NextWaypointIndex + " distance " + DistanceToNextWaypoint);
            }
        }
        ...
        protected virtual void DetermineNextWaypoint()
        {
            ...
            {
                if (NextWaypointIndex + 1 < _waypoints - 1)
                {
                    NextWaypointIndex++;
                }
                else
